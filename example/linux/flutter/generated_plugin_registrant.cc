...
#include <store_plugin/store_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) store_plugin_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "StorePlugin");
  store_plugin_register_with_registrar(store_plugin_registrar);
